        ...
        <div className="relative mx-auto max-w-7xl px-6 py-16 sm:px-8 lg:px-10">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-relaxed text-slate-600 sm:text-xl">
              Explore comprehensive guides, security details, and usage
              workflows designed for our suite of privacy-first browser
              utilities.
            </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 max-w-2xl text-sm leading-6 text-slate-600">
                    Read our primer on client-side browser execution to see how
          ...
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center">
            ...
            <div>
              ...
              <p className="mt-1 max-w-3xl text-sm leading-relaxed text-slate-600">
                Whether you are managing 5 or 100+ tools, FlagsDev maintains
                zero server side uploads for supported client processes. Your
