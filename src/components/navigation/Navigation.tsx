      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden items-center gap-3 md:flex">
          <Link
            ...
            className="flex items-center gap-2 rounded-xl border border-slate-200/80 bg-white px-3.5 py-2 text-sm font-medium text-slate-700 shadow-sm transition-all hover:border-slate-300 hover:bg-slate-50 hover:text-slate-900 active:scale-95"
          >
          ...
          <Link
            href="/sponsor"
            className="group flex items-center gap-2 rounded-xl border border-rose-200/60 bg-rose-50/50 px-3.5 py-2 text-sm font-medium text-rose-700 shadow-sm transition-all hover:border-rose-300 hover:bg-rose-100/50 hover:text-rose-800 active:scale-95"
          >
            <Heart className="h-4 w-4 fill-rose-500 text-rose-500 transition-transform duration-300 group-hover:scale-125" />
            <span>Sponsor</span>
          </Link>
        </div>
          ...
          <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3 border-t border-slate-100 pt-6">
              <Link
                ...
                rel="noopener noreferrer"
                onClick={() => setMobileOpen(false)}
                className="flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-3 text-sm font-medium text-slate-700 shadow-sm transition-all hover:bg-slate-50"
              >
                <FaGithub className="h-4 w-4 text-slate-800" />
                <span>GitHub</span>
              </Link>
              ...
              <Link
                href="/sponsor"
                onClick={() => setMobileOpen(false)}
                className="flex items-center justify-center gap-2 rounded-xl bg-rose-600 px-3 py-3 text-sm font-semibold text-white shadow-md shadow-rose-600/20 transition-all hover:bg-rose-700"
              >
